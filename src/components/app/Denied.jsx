  ...
  return (
    <div className="w-4/5">
      <div className="w-full mt-4 bg-slate-100 flex rounded-lg shadow-lg py-8 px-4">
        <div>
          <img
            src="https://coreldrawdesign.com/resources/previews/preview-error-401-access-denied-vector-creative-1612798070.jpg"
            alt="Denied"
          />
        </div>
        <div className="w-full flex flex-col">
          ...
          <div className="w-full mt-4">
            <Link to="/">
              <button className="w-3/5 p-2 bg-emerald-300 text-white font-semibold">
